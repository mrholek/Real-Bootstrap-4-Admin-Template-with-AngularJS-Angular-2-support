  ...
  render() {
    return (
      <header className="app-header navbar">
        ...
        <form className="form-inline float-left px-2 hidden-md-down">
          <i className="fa fa-search"></i>
          <input className="form-control" type="text" placeholder="Are you looking for something?"/>
        </form>
        <ul className="nav navbar-nav ml-auto">
          ...
          <li className="nav-item dropdown">
            <Dropdown isOpen={this.state.dropdownOpen} toggle={this.toggle}>
              ...
              <a onClick={this.toggle} className="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded={this.state.dropdownOpen}>
